...
function StyleCard({
  ...
  return (
    ...
    >
      <div className="relative flex h-20 items-center gap-3 overflow-hidden bg-surface-2/60 px-3">
        <span
      ...
      <div className="bg-surface px-3 py-2.5">
        <p className="flex items-center gap-2.5 text-[10px] tabular-nums text-muted-foreground">
